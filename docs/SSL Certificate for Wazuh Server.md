...
Replace existing wazuh.dashboard.pem and wazuh.dashboard-key.pem certificates in the folder ```/wazuh-docker/multi-node/config/wazuh_indexer_ssl_certs``` with SSL certificates from step 1.
